...
def compute_metrics_from_files(p_path_to_reference_file,
    ...
    for a in reference_query_ids:
        if a not in candidate_query_ids:
            print("query with query_id", a, "is in the refererence, but not in the candidate file")
    
#     print("length of common_query_ids", len(common_query_ids))
#     print("length of reference_query_ids", len(reference_query_ids))
#     print("length of candidate_query_ids", len(candidate_query_ids))
